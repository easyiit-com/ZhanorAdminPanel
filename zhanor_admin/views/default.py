...
#     next_url = request.route_url('dashboard', pagename='Dashboard')
#     return HTTPSeeOther(location=next_url)

# @view_config(route_name='view_page', renderer='zhanor_admin:templates/view.jinja2')
...
# @view_config(route_name='edit_page', renderer='zhanor_admin:templates/edit.jinja2')
...
# @view_config(route_name='add_page', renderer='zhanor_admin:templates/edit.jinja2')
