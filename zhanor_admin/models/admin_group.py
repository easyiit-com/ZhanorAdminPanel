...
class AdminGroup(Base):
    ...
    pid = Column(Integer, nullable=False,comment='Parent Group') 
    name = Column(String(100), nullable=False,comment='Group Name') 
    rules = Column(String(500), nullable=False, default = '*' ,comment='Rule IDs') 
