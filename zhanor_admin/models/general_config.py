...
class GeneralConfig(Base):
    ...
    name = Column(String(30), nullable=False,comment='Variable Name') 
    group = Column(String(30), nullable=False,comment='Group') 
    title = Column(String(100), nullable=False,comment='Variable Title') 
    tip = Column(String(100),comment='Variable Description') 
    type = Column(String(30),comment='Type: string, text, int, bool, array, datetime, date, file') 
    visible = Column(String(255),comment='Visibility Condition') 
    value = Column(Text,comment='Variable Value') 
    content = Column(Text,comment='Variable Dictionary Data') 
    rule = Column(String(100),comment='Validation Rule') 
    extend = Column(String(255),comment='Extended Attributes') 
    setting = Column(String(255),comment='Settings') 
