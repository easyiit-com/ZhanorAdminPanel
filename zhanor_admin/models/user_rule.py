...
class UserRule(Base):
    ...
    url_path = Column(String(150), nullable=False,comment='Url Path') 
    title = Column(String(50), nullable=False,comment='Title') 
    icon = Column(String(45), default = '' ,comment='Icon') 
    description = Column(String(100),comment='Description') 
    createtime = Column(DateTime,comment='Creation Time') 
    updatetime = Column(DateTime,comment='Update Time') 
    weigh = Column(Integer, default = '0' ,comment='Weight') 
