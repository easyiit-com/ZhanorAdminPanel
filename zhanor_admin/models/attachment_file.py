...
class AttachmentFile(Base):
    ...
    path_file = Column(String(255), nullable=False, default = '' ,comment='Physical Path') 
    file_name = Column(String(100), default = '' ,comment='File Name') 
    ...
    updatetime = Column(DateTime, nullable=False,comment='Update Time') 
    storage = Column(String(100), nullable=False,comment='Storage Location') 
