...
class CommonSms(Base):
    __tablename__ = 'common_sms'
    id = Column(Integer, primary_key=True, nullable=False,comment='ID') 
    event = Column(String(30), default = '' ,comment='Event') 
    mobile = Column(String(20), default = '' ,comment='Phone Number') 
    code = Column(String(10), default = '' ,comment='Verification Code') 
    times = Column(Integer, nullable=False, default = '0' ,comment='Validation Attempts') 
    ip = Column(String(30), default = '' ,comment='IP Address') 
