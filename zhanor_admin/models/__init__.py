...
from .admin_user import AdminUser # njh
from .admin_group import AdminGroup # njh
from .admin_log import AdminLog # njh
from .admin_rule import AdminRule # njh

from .attachment_file import AttachmentFile  # njh
from .attachment_image import AttachmentImage # njh
from .general_category import GeneralCategory # njh
from .common_ems import CommonEms
from .common_sms import CommonSms
from .general_config import GeneralConfig # njh
from .user_user import UserUser # njh
from .user_balance_log import UserBalanceLog # njh
from .user_group import UserGroup # njh
from .user_rule import UserRule # njh
from .user_score_log import UserScoreLog # njh
...
def includeme(config):
    ...
    Activate this setup using ``config.include('zhanor_admin.models')``.
