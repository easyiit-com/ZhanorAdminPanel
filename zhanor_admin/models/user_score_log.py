...
class UserScoreLog(Base):
    ...
    score = Column(Integer, nullable=False,comment='Change in Scores') 
    before = Column(Integer, nullable=False,comment='Points Before Change') 
    after = Column(Integer, nullable=False,comment='Points After Change') 
