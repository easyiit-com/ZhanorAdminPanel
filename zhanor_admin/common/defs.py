...
from zhanor_admin.models.common_ems import CommonEms
from zhanor_admin.models.common_sms import CommonSms
...
def now(request):
    ...
    default_timezone_str = settings.get('default.timezone', 'UTC') 
